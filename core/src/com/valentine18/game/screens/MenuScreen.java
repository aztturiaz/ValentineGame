...
public class MenuScreen extends AbstractGameScreen
{
    ...
    {
        skinValentine18 = new Skin(
                Gdx.files.internal(Constants.SKIN_VALENTINE_UI),
    ...
    private Table buildBackgroundLayer ()
    {
        ...
        // + Background
        imgBackground = new Image(skinValentine18, "background");
